...
export default function Header() {
    ...
    return (
        <nav className="flex flex-col w-full py-5 px-5 md:px-20 lg:px-32 xl:px-52 gap-4 lg:gap-0 relative">
            <div className="flex flex-col lg:flex-row">
                ...
                <div className="flex flex-row mt-4 lg:mt-0 text-start lg:justify-end lg:items-end lg:text-end justify-between lg:ml-auto text-white font-black lg:gap-5 text-sm lg:text-lg">
